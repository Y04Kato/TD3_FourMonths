...
void Mountain::Initialize()
{
	...
	worldTransform_[0].translation_ = { -13.0f,-4.0f,20.0f };
	worldTransform_[0].scale_ = { 1.0f,1.0f,3.0f };

	worldTransform_[1].translation_ = { 13.0f,-4.0f,20.0f };
	worldTransform_[1].rotation_ = {0.0f,3.13f,0.0f};
	worldTransform_[1].scale_ = { 1.0f,1.0f,3.0f };
