...
void GamePlayScene6::Initialize() {
	...
	uiResource_[4] = textureManager_->Load("project/gamedata/resources/UI/stage6.png");
...
void GamePlayScene6::Finalize() {
	delete player_;

	objects_.clear();
}

void GamePlayScene6::ApplyGlobalVariables() {
...
void GamePlayScene6::SetObject(EulerTransform trans, const std::string& name) {
	Obj obj;
