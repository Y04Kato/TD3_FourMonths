...
void GamePlayScene5::Initialize() {
	...
	uiResource_[4] = textureManager_->Load("project/gamedata/resources/UI/stage5.png");
...
void GamePlayScene5::ApplyGlobalVariables() {
...
void GamePlayScene5::SetObject(EulerTransform trans, const std::string& name) {
	Obj obj;
